...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public Template(MainView parent, MainView parentInstance): base("ContentList", false)
        {
            __parent = parent;
        ...
        {
            var __self = new global::ContentList(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "ContentList";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("ContentDetails", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::ContentDetails(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "ContentDetails";
    }
    ...
    void InitializeUX()
    {
        ...
        var ContentList = new Template(this, this);
        var ContentDetails = new Template1(this, this);
        var temp20 = new global::Fuse.Reactive.JavaScript(__g_nametable);
        this.Background = float4(0.06666667f, 0.06666667f, 0.07843138f, 1f);
        ...
        temp19.Templates.Add(ContentList);
        temp19.Templates.Add(ContentDetails);
        temp20.LineNumber = 10;
